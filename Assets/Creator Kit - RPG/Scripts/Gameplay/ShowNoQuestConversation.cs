...
namespace RPGM.Events
{
    ...
    /// It does NOT expect there to be a quest for this.
    /// </summary>
    /// <typeparam name="ShowNoQuestConversation"></typeparam>
    public class ShowNoQuestConversation : Event<ShowNoQuestConversation>
    {
